...
depths <- as.numeric(substr(colnames(dataIn)[2:nCols],5,10)) #commented out by IAO
# depths <- as.numeric(substr(colnames(dataIn)[2:nCols],4,10)) #need to change 5 -> 4 when column names start with 'wtr' and not 'temp'
