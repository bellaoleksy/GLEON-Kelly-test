...
A <- compareVals %>%
  ...
  ggpp::geom_label_npc(aes(npcx = "left", npcy = "top",
                           label = paste("RMSE =",round(Metrics::rmse(compareVals$TPHat,compareVals$TP),1))),
                 size=3, alpha=0.5)
...
B  <- compareVals %>%
  ...
  scale_y_log10(name = expression(paste('Modeled lake DOC (g m'^-3,')')),
                ...
                limits = c(0.3,30))+
  ggpp::geom_label_npc(aes(npcx = "left", npcy = "top",
                           label = paste("RMSE =",round(Metrics::rmse(compareVals$CHat,compareVals$DOC),1))),
                 size=3, alpha=0.5)
...
C  <- compareVals %>%
  ...
  scale_y_log10(name = expression(paste('Modeled z'[mix],' (m)')),
                ...
                limits = c(1,30))+
  ggpp::geom_label_npc(aes(npcx = "left", npcy = "top",
                           label = paste("RMSE =",round(Metrics::rmse(compareVals$zMixHat,compareVals$meanzMix),1))),
                 size=3, alpha=0.5)
...
C  <- all_compareVals %>%
  ...
  scale_y_log10(name = expression(paste('Modeled z'[mix],' (m)')),
                ...
                limits = c(1,30))+
  ggpp::geom_label_npc(aes(npcx = "left", npcy = "top",
                           label = paste("RMSE =",round(Metrics::rmse(actual_zmix,pred_zmix),1))),
                 size=3, alpha=0.5)
