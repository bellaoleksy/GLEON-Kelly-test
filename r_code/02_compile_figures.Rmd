...
GPP_correlations  
ggsave(here("figures/GPP_correlations.png"), dpi=600, width=6,height=8, units="in")



## Second version uses only PREDICTED values. 
...
my_labeller <- as_labeller(c(HRT_days="log[10]~HRT~(days)", LSA_km2="log[10]~Surface~Area~(km^2)",
                             ...
                             CHat="DOC[lake]~(mg~L^1)", TPHat="TP[lake]~(mu~g~L^-1)",
