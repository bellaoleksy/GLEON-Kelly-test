...
#Sanity check- now how to the modeled versus measured loads compared?
master_df %>%
  ggplot(aes(x=log10(DOC_load_modeled), y=log10(DOC_load_measured)))+
  geom_point()+
  geom_abline(intercept=0, slope=1)

master_df %>%
  ggplot(aes(x=log10(TP_load_modeled), y=log10(TP_load_measured)))+
  geom_point()+
  geom_abline(intercept=0, slope=1)
