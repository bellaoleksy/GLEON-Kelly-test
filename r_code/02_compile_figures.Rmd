...
### Figure 3 - TP vs DOC as a ftn of GPP
```{r}
...
combined <- TP_DOC_ins + TP_DOC_lake &   theme(legend.position="bottom",
        legend.text.align = 0.5,
        legend.margin = margin(0, 0, 0, 0))
combined +  plot_annotation(tag_levels = 'A') +
  plot_layout(guides = "collect")
  
ggsave(here("figures/MS/Figure3.TPinvsDOCin_GPP.png"), width=6, height=4,units="in", dpi=600)
...
#### Figure S5. Parameter histograms
```{r}
