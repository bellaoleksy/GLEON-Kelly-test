##This file was created to see how well we can model metabolism using only 6 hour data (for NYC DEP reservoir systems)
...
WL_DO<-sensordbTable("DO_CORR",lakeID="WL",minDate = '2014-06-01', maxDate = '2014-08-31') 
  ...
  filter(time %in% c("1:0",
                     ...
                     "13:0",
                     "19:0",
                     "25:0")) #extract only 5 times per day
  write.table(WL_DO_YSI, file="GLEON/data/WL_DO.txt", sep = "\t", row.names = FALSE)
...
timeStep=10
sensorDepth=0.7
#Changed these from "dateTime" to "datetime" on 2020/02/13
...
##########Commented out as an experiment 2020/02/13
# if(fluxDummyToggle){
