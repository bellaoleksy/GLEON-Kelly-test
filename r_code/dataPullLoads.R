...
dir<-'/Volumes/GoogleDrive/My Drive/Research (common)/Research/Data/R/catchment_metab_wg/results/nutrient load/' # directory of load data
...
Loch_Q_inlet<-read.csv("/Volumes/GoogleDrive/My Drive/Research (common)/Research/Data/R/LVWS-long-term-data/data_clean/metabolism/LochInOut_Q_UVs_CY2015_17.csv", stringsAsFactors = F) %>%
...
##############Loch and Sky
Loch_C_inlet <- read.csv("/Volumes/GoogleDrive/My Drive/Research (common)/Research/Data/R/LVWS-long-term-data/data_clean/surface_chem/LVWS_surfacewaterchemistry_master_180211.csv", stringsAsFactors = F)
